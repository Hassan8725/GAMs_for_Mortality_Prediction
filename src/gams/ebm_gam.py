...
def train_ebm_model(
    ...
    **kwargs: Dict[str, Any]
    ...
    """
    Trains an Explainable Boosting Machine (EBM) model with specified or default
    parameters on the provided training data and returns predictions,
    probabilities, model summary, and training accuracy.
    ...
    :param max_bins: Maximum number of bins for continuous features.
        Default is 1024.
    :param max_interaction_bins: Maximum number of bins for interaction terms.
        Default is 32.
    :param interactions: Fraction of pairwise interactions to consider.
        Default is 0.9.
    :param exclude: List of features to exclude from the model.
        Default is None.
    :param validation_size: Proportion of data to set aside for validation.
        Default is 0.15.
    :param outer_bags: Number of outer bags for the ensemble. Default is 14.
    :param inner_bags: Number of inner bags for estimating mean and variance.
        Default is 0.
    ...
    :param interaction_smoothing_rounds: Rounds for smoothing interactions.
        Default is 50.
    :param max_rounds: Maximum number of boosting rounds. Default is 25000.
    :param early_stopping_rounds: Rounds of no improvement to stop training early.
        Default is 50.
    ...
    :param monotone_constraints: Constraints on monotonicity of features.
        Default is None.
    ...
    :return: A tuple containing the trained EBM model and a dictionary with
        predictions, probabilities, model summary, and training accuracy.
    """
...
def display_global_explanation_with_full_feature_names(model, feature_names: list):
    """
    Displays the global explanation of an EBM model with both individual
    and combined feature names.

    :param model: Trained EBM model
        (ExplainableBoostingClassifier or ExplainableBoostingRegressor).
    :param feature_names: List of feature names corresponding to the
    ...
    global_explanation.data()["names"] = [
        name_mapping[name] for name in original_feature_names
    ]
